...
Gem::Specification.new do |spec|
  ...
  spec.metadata['source_code_uri'] = 'https://github.com/philiprehberger/rb-token-bucket'
  spec.metadata['changelog_uri'] = 'https://github.com/philiprehberger/rb-token-bucket/blob/main/CHANGELOG.md'
  spec.metadata['bug_tracker_uri'] = 'https://github.com/philiprehberger/rb-token-bucket/issues'
